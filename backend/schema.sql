...
INSERT INTO site_content (content_key, content_value) VALUES
    ...
    ('about_image', ''),
    ('highlight_1', 'Más de 30 años de experiencia en carreteras, puentes y aeropuertos'),
    ('highlight_2', 'Experiencia en sector público y privado'),
    ('highlight_3', 'Amplia red de contactos: concesionarias, Dirección de Vialidad y aeropuertos'),
    ('whyus_title', 'Confianza construida en cada proyecto'),
    ('whyus_pillar_1_title', 'Más de 30 años de experiencia'),
    ('whyus_pillar_1_text', 'En carreteras, puentes y aeropuertos, en el sector público y privado.'),
    ('whyus_pillar_2_title', 'Áreas de especialización'),
    ('whyus_pillar_2_text', 'Obras viales, aeropuertos y gran minería: movimientos de tierra, pavimentos y plantas de producción.'),
    ('whyus_pillar_3_title', 'Amplia red de gestión'),
    ('whyus_pillar_3_text', 'Contactos con Empresas Concesionarias, Dirección de Vialidad, aeropuertos, constructoras y transportistas.'),
    ('whyus_pillar_4_title', 'Asesoría y asistencia técnica'),
